...
// vendored from @juanbenjumea/opencode-go-usage (was an npm dep; vendored
// alongside this forked footer so the local extension is self-contained).
import { parseOpenCodeGoDashboard } from "../vendor/opencode-go-usage/lib/dashboard.ts";
import { fetchDashboardUsage } from "../vendor/opencode-go-usage/lib/fetch.ts";
import type { OpenCodeGoWindow } from "../vendor/opencode-go-usage/lib/types.ts";
