...
If something goes wrong (no PR, no comments, rate limited, auth) or you want the common-mistakes checklist: `read skills/address-pr-comments/TROUBLESHOOTING.md` (path relative to the pi config dir).

Announce at start: "I'm using the /address-pr-comments command to review and address PR comments."
...
<!-- Vendored from skills/address-pr-comments/SKILL.md as a pi prompt template (user-invocation command /address-pr-comments). -->
