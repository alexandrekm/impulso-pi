...
<!-- Vendored from https://github.com/humanlayer/skills/blob/main/plugins/show-me/skills/show-me/SKILL.md as a pi prompt template (user-invocation command /show-me, not a model-invocable skill). Re-sync manually if upstream changes. -->
